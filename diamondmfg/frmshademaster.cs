...
namespace diamondmfg
{
    public partial class frmshademaster : Form
    {
        ...
        public frmshademaster(string lbusername)
        {
            InitializeComponent();
            ...
            con.Open();
            SqlCommand cmdl = new SqlCommand("select addright,updateright,viewright,deleteright,printright from userrights where username = '" + lbusername.ToString() + "' and formname = 'frmshademaster'", con);
        ...
        public void disp_Shade()
        {
            ...
            cmd.CommandText = "select * from shademaster";
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into shademaster values('" + textBox2.Text + "')", con);
        ...
        private void btnU_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update shademaster set shade_name = '" + textBox2.Text + "' where id = '" + textBox1.Text + "'  ", con);
        ...
        private void btnD_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("delete from shademaster where id = '" + textBox1.Text + "'  ", con);
        ...
        private void frmshademaster_Load(object sender, EventArgs e)
        {
            disp_Shade();
        }
    }
