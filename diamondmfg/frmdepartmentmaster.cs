...
namespace diamondmfg
{
    public partial class frmdepartmentmaster : Form
    {
        ...
        public frmdepartmentmaster(string lbusername)
        {
            InitializeComponent();
        ...
        public void disp_dep()
        {
            ...
            cmd.CommandText = "select * from depmaster";
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into depmaster values('" + textBox2.Text + "')", con);
        ...
        private void btnU_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update depmaster set dep_name = '" + textBox2.Text + "' where id = '" + textBox1.Text + "'  ", con);
        ...
        private void btnD_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("delete from depMASTER where id = '" + textBox1.Text + "'  ", con);
